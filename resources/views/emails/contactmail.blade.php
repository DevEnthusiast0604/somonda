                                                    ...
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td class="text-center pb25"
                                                                ...
                                                                <span class="m-hide"><br /></span>New Contact Mail is Arrived 
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="text-center pb25"
                                                                style="color:#c1cddc; font-family:'Muli', Arial,sans-serif; font-size:16px; line-height:30px; text-align:center; padding-bottom:15px;">
                                                                 <p style="color:white">Name:  {{$email['name']}} </p>
                                                                 <p style="color:white">Email:  {{$email['email']}}</p>
                                                                  <p style="color:white">{{$email['subject']}}</p>
                                                                 <p style="color:white">{{$email['message']}}</p>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
