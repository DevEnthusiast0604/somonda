            ...
            <div class="row">
                <div class="col-sm-6 col-md-3">
                    <div class="intro-item mx-auto">
                        ...
                        <h4 class="text-center">Save up to 80%</h4>
                        <p class="text-center">On more than 1.000 well known brands</p>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="intro-item mx-auto">
                        ...
                        <p class="text-center">Get fast and free delivery all over the world</p>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="intro-item mx-auto">
                        ...
                        <h4 class="text-center">Secure payment</h4>
                        <p class="text-center">We use SSL and ensure that you are secure when you shop on our site</p>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="intro-item mx-auto">
                        ...
                        <h4 class="text-center">24/7 Customer Support</h4>
                        <p class="text-center">Do you have any questions or issues? Then don't hesitate to contact us</p>
                    </div>
                </div>
            </div>
        </div>
...
<section class="bestseller" id="popular_products">
    <div class="container">
        <div class="bestseller-area">
            <div class="heading">
                <h2 class="text-center">Bestsellers <span>for you</span></h2>
        ...
        <div class="product-area">
            ...
            <div class="footer d-flex justify-content-center">
                <div class="get-in-touch-btn text-center">
                    <a href="{{route('products.all')}}" class="text-white py-1"><span>View all new products</span></a>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="popcontent" style="padding-top: 30px; padding-bottom: 30px">
                                ...
                                PlusDeal' prices are for both members and non-members.
                                Membership costs  
                                ...
                                <p style="text-align: center; font-size: 15px; width: 80%; margin: auto;">
                                    ...
                                    Read more <a href="{{route('terms')}}"
                                        style="color: #2e2e2e; text-decoration: underline">here</a>
                                </p>
