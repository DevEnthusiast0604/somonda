                    ...
                    <div class="phonesbox clearfix">
                        <div class="badge clearfix animated jackInTheBox text-white"
                            ...
                            <p class="price">
                                ...
                                <span>
                                    @if(app()->getLocale() == 'sv')
                                    {{number_format($data->wholesalePrice * sek_rate())}} Kr
                                    @elseif(app()->getLocale() == 'no')
                                    {{number_format($data->wholesalePrice * nok_rate())}} Kr
                                    @else
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="main_lef text-center">
                        ...
                        <div class="formcontainer signup_form clearfix" id="scroll-form">
                            ...
                            <div class="info-form">
                                <form method="POST" id="cart-form" action="{{route('purchase.checkout')}}" method="post"
                                    enctype="multipart/form-data" style="margin-top: 10px;"
                                    class="mx-4 form-sub-heading was-validated">
                                    @csrf
                                    <input type="hidden" name="product_id" value="{{$data->id}}">
                                    <div class="row row-input">
                                        <div class="col-6" style="padding: 0 5px">
                                            <input type="text" id="firstname" name="first_name" placeholder="@lang('first_name')"
                                                required="" class="form-control unedited-field" value="{{session()->get('first_name')}}"
                                                maxlength="255">
                                        </div>
                                        <div class="col-6" style="padding: 0 5px">
                                            <input type="text" id="lastname" name="last_name"
                                                placeholder="@lang('last_name')" value="{{session()->get('last_name')}}" required=""
                                                class="form-control unedited-field" maxlength="255">
                                        </div>
                                    </div>
                                    <div class="row row-input">
                                        <div class="col-12" style="padding: 10px 5px 0">
                                            <input id="address" name="address" type="text" placeholder="@lang('address')"
                                                value="{{session()->get('address')}}" required class="form-control" maxlength="255">
                                        </div>
                                    </div>
                                    <div class="row row-input">
                                        <div class="col-6" style="padding: 10px 5px 0">
                                            <input id="zipcode" name="zipcode" type="text" placeholder="@lang('postal_code')"
                                                value="{{session()->get('zipcode')}}" required="" class="form-control" minlength="4" maxlength="12">
                                        </div>
                                        <div class="col-6" style="padding: 10px 5px 0">
                                            <input id="city" name="city" type="text" placeholder="@lang('city')" value="{{session()->get('city')}}"
                                    ...
                                    <div class="row row-input">
                                        ...
                                        <div class="col-6" style="padding: 10px 5px 0">
                                            <!-- <input id="intl-phone" name="intl-phone" type="text"   value=""
                                                class="unedited-field"> -->
                                            <input type="tel" id="phonenumber" name="phone" value="{{session()->get('phone')}}"
                                                placeholder="@lang('telephone')" required=""
                                                class="form-control" pattern="[0-9]{5,16}">
                                        </div>
                                    </div>
                                    <div class="row row-input">
                                        <div class="col-12" style="padding: 10px 5px 10px">
                                            <input type="email" id="email" name="email" placeholder="@lang('email')" value="{{session()->get('email')}}"
                                                required="" class="form-control unedited-field" minlength="9"
                                                maxlength="255">
                                        </div>
                                    </div>

                                    <div class="row mt-2 p-2 terms-container">
