            ...
            <div class="card my-3 border-0">
                <div class="d-flex">
                    <div class="card-img_wrapper">
                        ...
                        <img src="{{asset('uploads/products')}}/{{$row->attributes->image}}" class="img-fluid rounded-start"  alt="">
                        @else
                        <img src="{{$row->attributes->image}}" class="img-fluid rounded-start" alt="">
                        @endif
                    </div>
    ...
    <div class="payment_wrapper">
        ...
        <div class="check_btn_wrapper row">
            ...
            <div class="col-12 d-flex justify-content-center">
                <img src="{{asset('assets/images/visa_master.png')}}" width="150" alt="Payment Image">
            </div>
        </div>
    </div>
